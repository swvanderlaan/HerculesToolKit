...
echo "+ * last edited on: 2019-01-23                                                     +"
echo "+                                                                                  +"
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
Rscript $HOME/git/HerculesToolKit/_rstats_installers/RStats_Updater_v1.r
echo ""
echo "* Now, updating general statistics packages..."
say -v Samantha "Now, updating general statistics packages."
Rscript $HOME/git/HerculesToolKit/_rstats_installers/Rstats_GENERAL_v1.r
echo ""
...
Rscript $HOME/git/HerculesToolKit/_rstats_installers/Rstats_ADVANCED_v1.r
echo ""
echo "* Moving on to updating genetics packages..."
say -v Samantha "Moving on to updating genetics packages."
Rscript $HOME/git/HerculesToolKit/_rstats_installers/Rstats_GENETICS_v1.r
...
Rscript $HOME/git/HerculesToolKit/_rstats_installers/Rstats_OMICS_v1.r
echo "* Finally, updating MR-analyses packages..."
say -v Samantha "Finally, updating MR-analyses packages."
Rscript $HOME/git/HerculesToolKit/_rstats_installers/Rstats_MR_v1.r
echo ""
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
