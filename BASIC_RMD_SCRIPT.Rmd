...
# RESULTS = paste0(ROOT_loc, "/PLINK/analyses/expressscan/qualitycontrol")
RAWDATA = paste0(ROOT_loc, "/PLINK/analyses/expressscan/rawdata")
PROJECT_loc = paste0(ROOT_loc, "/PLINK/analyses/expressscan")

### SOME VARIABLES WE NEED DOWN THE LINE
cat("\nDefining phenotypes and datasets.\n")
PROJECTNAME="ExpressScan"
SUBPROJECTNAME="QC"
STAIN="SR"

cat("\nCreate a new analysis directory, including subdirectories.\n")
# Analysis
ifelse(!dir.exists(file.path(PROJECT_loc, "/",paste0(PROJECTNAME,"_",SUBPROJECTNAME))), 
       dir.create(file.path(PROJECT_loc, "/",paste0(PROJECTNAME,"_",SUBPROJECTNAME))), 
       FALSE)
ANALYSIS_loc = paste0(PROJECT_loc,"/",paste0(PROJECTNAME,"_",SUBPROJECTNAME))
